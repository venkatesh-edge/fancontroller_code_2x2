...
const int fanA1 = 48;           // PWM Fan A1 pin
const int fanA2 = 21;           // PWM Fan A2 pin
const int fanB1 = 13;           // PWM Fan B1 pin
const int fanB2 = 11;           // PWM Fan B2 pin
const int tachoA1 = 47;         // Tacho for Fan A1
const int tachoA2 = 14;         // Tacho for Fan A2
const int tachoB1 = 12;         // Tacho for Fan B1
const int tachoB2 = 10;         // Tacho for Fan B2
